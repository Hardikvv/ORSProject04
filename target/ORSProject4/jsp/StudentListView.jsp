...
<%@page import="com.ncs.Model.StudentModel"%>
<%@page import="com.ncs.controller.StudentListCtl"%>
<%@page import="java.util.Iterator"%>
<%@page import="com.ncs.beans.StudentBean"%>
...
<body>
	<jsp:useBean id="cbean" class="com.ncs.beans.CollegeBean"
			...
			<table style="text-align: center;">
				<tr>
					<td align="right"><label> First Name:</label> <input
						...
						&nbsp; <label>College Name:</label> <%=HTMLUtility.getList("collegeid", ServletUtility.getParameter("collegeid", request), clist)%>
