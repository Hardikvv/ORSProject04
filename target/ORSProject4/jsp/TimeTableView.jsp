...
<%@page import="com.ncs.controller.TimeTableCtl"%>
...
<%@page import="com.ncs.beans.TimeTableBean"%>
...
<body>
	<jsp:useBean id="bean" class="com.ncs.beans.TimeTableBean"
	...
	<form action="<%=ORSView.TIMETABLE_CTL%>" method="post">
		...
		<center>
			<%
				ArrayList<TimeTableBean> courseList = (ArrayList<TimeTableBean>) request.getAttribute("CourseList");
				ArrayList<TimeTableBean> subjectList = (ArrayList<TimeTableBean>) request.getAttribute("SubjectList");
			%>
